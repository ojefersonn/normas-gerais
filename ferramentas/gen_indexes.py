...
def main():
    ...
    r = []
    r.append("# 📚 Normas Gerais")
    r.append("")
    r.append("_Acervo pesquisável de normas de licitações, contratos e gestão administrativa federal._")
    r.append("")
    ...
    r.append("- **No site de busca:** abra o [buscador do acervo](https://ojefersonn.github.io/normas-gerais/) para")
    ...
    r.append("- **Perguntando em linguagem natural:** use o [assistente com IA](assistente/README.md), que")
    r.append("  responde com citações de norma e artigo (requer chave de API da Anthropic).")
    r.append("")
    ...
    r.append("assistente/              ← assistente de consulta com IA (protótipo RAG)")
